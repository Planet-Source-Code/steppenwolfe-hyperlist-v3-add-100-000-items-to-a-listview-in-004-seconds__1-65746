...
Public Type IPAOHookStruct
    ...
    Ctl                                     As ucHyperList               'Un-AddRefed native class pointer for making Friend calls
    ThisPointer                             As Long
End Type
...
Private Declare Function IsEqualGUID Lib "ole32" (iid1 As GUID, _
...
Private Function ContextSensitiveHelp(This As IPAOHookStruct, _
                                      ByVal fEnterMode As Long) As Long

    ContextSensitiveHelp = This.IPAOReal.ContextSensitiveHelp(fEnterMode)

End Function

Private Function EnableModeless(This As IPAOHookStruct, _
...
Private Function GetWindow(This As IPAOHookStruct, _
...
Public Sub InitIPAO(IPAOHookStruct As IPAOHookStruct, _
                    Ctl As ucHyperList)
...
Private Function OnDocWindowActivate(This As IPAOHookStruct, _
...
Private Function OnFrameWindowActivate(This As IPAOHookStruct, _
                                       ByVal fActivate As Long) As Long
...
Private Function QueryInterface(This As IPAOHookStruct, _
                                riid As GUID, _
...
Private Function ResizeBorder(This As IPAOHookStruct, _
                              prcBorder As RECT, _
                              ByVal puiWindow As IOleInPlaceUIWindow, _
                              ByVal fFrameWindow As Long) As Long
...
Private Function TranslateAccelerator(This As IPAOHookStruct, _
